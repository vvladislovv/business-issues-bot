...
async def init_default_messages():
    ...
    try:
        # System messages
        system_messages = {
            "start": """👋 Привет! Я помогу тебе за 2 минуты понять, можешь ли ты получить соцконтракт от государства на 350 000₽.\n\nЭто безвозвратные деньги — тратить их можно на развитие своего дела: фриланс, копирайтинг, блог, дизайн, обучение, технику и не только.\n\nПогнали? 😉\n👇""",
        ...
        survey_messages = {
            ...
            "mid_survey": """✨ Отлично, ты уже на полпути!

Судя по ответам, ты точно подходишь под основные требования 💡
Осталось совсем чуть-чуть — и узнаешь, можно ли тебе получить до 350 000₽ от государства на запуск или развитие своего дела 🧑‍💻
